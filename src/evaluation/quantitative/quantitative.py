...
def run_quantitative_benchmark(test_dataset, model_configs):
    ...
    for config in model_configs:
        ...
        for i, row in enumerate(test_dataset):
            ...
            total_ingredient_coverage += metrics["recipe_metrics"]["ingredient_coverage"]
            total_temperature_validation += metrics["recipe_metrics"]["temperature_validation"]
            total_allergen_handling += metrics["recipe_metrics"]["allergen_handling"]
